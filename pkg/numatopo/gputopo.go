...
// GetPodAllocations returns nil; GPU topology discovery does not track
// per-pod allocations, which are a CPU manager concern.
func (info *GPUNumaInfo) GetPodAllocations() []v1alpha1.PodAllocation {
	return nil
}
